                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="text-right">
                            <button type="submit" name="send_wireless_ap" class="btn btn-primary">ارسال <i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
...
<script src="<?php echo __ROOT__ . '/public/js/wireless_ap.js' ?>"></script>
<!-- /theme JS files -->