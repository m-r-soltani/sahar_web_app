                    ...
                    <form action="" method="POST">
                        <fieldset class="mb-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="tol_joghrafiai" placeholder="مثال: [ثانیه][دقیقه]N[درجه]">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">عرض جغرافیایی</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="arz_joghrafiai" placeholder="مثال: [ثانیه][دقیقه]E[درجه]">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">بهره آنتن(dbi)</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="bahre_anten" placeholder="مثال: 27 ">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">شماره سریال دستگاه</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="shomare_serial_dastgah" placeholder="مثال: 831207D90E6">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">مشخصات دستگاه</label>
                                <div class="col-lg-4">
                                    <select class="form-control form-control-lg">
                                        <option value="1">5470-5725 Mhz</option>
                                        <option value="2">5725-5850 Mhz</option>
                                        <option value="3">5250-5350 Mhz</option>
                                        <option value="4">2400-2483/5 Mhz</option>
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="ostan" placeholder="مثال: تک باند فرکانسی 57255470 مگاهرتز">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">مارک دستگاه</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="ostan" placeholder="مثال: MikroTik">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">مدل دستگاه</label>
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="modele_dastgah" placeholder="مثال: RouterBOADRD LHG 5HPnD-XL">
                                </div>
                                <br><br>
                                <label class="col-form-label col-lg-2">مارک دستگاه</label>
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-4">
                                    <input type="text" class="form-control" name="eng_name_modir" placeholder="مثال: Mohammad">
                                </div>
                                <br><br>
