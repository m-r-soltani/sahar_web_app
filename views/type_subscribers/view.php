            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="#" method="POST">
                        <fieldset class="mb-3">
                            <legend class="text-uppercase font-size-sm font-weight-bold">نوع مشتری</legend>

                            <div class="form-group row">
                                <label class="col-form-label col-lg-2">نوع مشتری</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="noe_moshtari" placeholder="مثال: حقوقی">
                                </div>
                            </div>
                        </fieldset>
