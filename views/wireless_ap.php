            ...
            <form action="" method="POST">
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="shenase_dakal" id="shenase_dakal"
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="tol_joghrafiai" id="tol_joghrafiai"
                                   placeholder="مثال: [ثانیه][دقیقه]N[درجه]">
                        </div>
                        <br><br>
                        <label class="col-form-label col-lg-2">عرض جغرافیایی</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="arz_joghrafiai" id="arz_joghrafiai"
                                   placeholder="مثال: [ثانیه][دقیقه]E[درجه]">
                        </div>
                        <br><br>
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" name="hadeaxar_tavane_khoroji_ferestande"
                                   ...
                                   placeholder="مثال: تک باند فرکانسی 57255470 مگاهرتز">
                        </div>
                        <br><br>
                        <label class="col-form-label col-lg-2">مارک دستگاه</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="marke_dastgah" id="marke_dastgah"
                                   placeholder="مثال: MikroTik">
                        </div>
                        <br><br>
                        <label class="col-form-label col-lg-2">مدل دستگاه</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="modele_dastgah" id="modele_dastgah"
                                   placeholder="مثال: RouterBOADRD LHG 5HPnD-XL">
                        </div>
                        <br><br>
                        <label class="col-form-label col-lg-2">مارک دستگاه</label>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="port_winbox" id="port_winbox"
                                   placeholder="مثال: 80">
                        </div>
                        <br><br>
