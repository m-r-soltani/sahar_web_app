...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card" style="padding: 2px;">
            <div class="col-md-12">
                <button name="initconfirm" class="btn btn-primary col-md-auto float-md-right" id="initconfirm">جستجو<i class="icon-database-edit2 ml-2"></i></button>
        ...
        <!--<div class="card">
            <div class="card-body factors_tab1 col-lg-12">
                <div class="factors_tab1_box" id="factors_tab1_box">سفارش جدید</div>
                <div class="factors_tab1_box" id="factors_tab2_box">فاکتور ها</div>
                <div class="factors_tab1_box" id="factors_tab3_box">اختصاص امکانات</div>
                <div class="factors_tab1_box" id="factors_tab4_box">پرداخت ها</div>
                <div class="factors_tab1_box" id="factors_tab5_box">مشکلات</div>
                <div class="factors_tab1_box" id="factors_tab6_box">تماس</div>
            </div>
        </div>-->
        <!--1st tabs-->
        <!--2nd tabs-->
        <div class="card">
            <div class="card-body secondtabs">
