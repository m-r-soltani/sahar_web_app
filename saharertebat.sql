...
(2, 'شرکت1', '123', '123', '123', 'سهامی خاص', 'www.asdad.com', 'mokhtarpour@gmail.com', 123, 123, '123', '2', '30', 1232313, 'address', 'fighter.jpg', 'fighter.jpg', 'fighter.jpg', 'fighter.jpg', 'fighter.jpg', 'fighter.jpg', 'fighter.jpg'),
...
(1, 'province', 'استان', 1),
(2, 'city', 'شهر', 1),
(3, 'organization_level', 'نمایندگی - سمت سازمانی', 3),
(4, 'tax', 'مالیات', 1),
(6, 'restrictions', 'نمایندگی - دسترسی پرسنل', 3),
(7, 'popsite', 'popsite', 2),
(8, 'telecommunications_center', 'مرکز مخابراتی', 2),
(9, 'terminal', 'مرکز مخابراتی - ترمینال', 2),
(10, 'pre_number', 'مرکز مخابراتی - پیش شماره', 2),
(11, 'host', 'میزبان', 1),
(12, 'wireless_ap', 'Wireless-AP', 2),
(13, 'wireless_station', 'Wireless-Staion', 2),
(14, 'services', 'سرویس ها', 1),
(15, 'branch', 'نمایندگی', 3),
(16, 'operator', 'نمایندگی - پرسنل', 3),
(17, 'real_subscribers', 'مشترکین - حقیقی', 4),
(18, 'legal_subscribers', 'مشترکین - حقوقی', 4),
(19, 'factors', 'مشترکین - فاکتورها', 4),
(20, 'modir', 'نمایندگی - مدیر', 3);
...
(2, 'test2', 12, 'test2', 123, 123, 'test2', 'test2', 'fighter.jpg', 'sdf', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 234);
...
(1, NULL, 'amintest', 'soltani', 12312, '24', 'sf', '0000-00-00', 'diplom', 'asd', 'asd', 'asd', 123, 123, 'asd', 'sfd@asdas.com', NULL, 'amin1', 'amin1', '', '', '', '', 2, 5);
...
CREATE TABLE `bnm_pre_number` (
  `id` int(11) NOT NULL,
  `name_markaz` varchar(50) CHARACTER SET utf8 COLLATE utf8_persian_ci DEFAULT NULL,
...
(1, 'VDSL(Share)', 'no', 'no', 'adasd', 'sdf', 'sdf', 'aaaaaa', 0, '0000-00-00', '0000-00-00', 'sdf', 'df', '123', '13', '1', '1', '#27ADCA', '#27ADCA', 'sdf', 'sdf', 'sdf', '13', '123', 13, 123, 123, 123, 123, 'sdf', 'd', 123, 123, 123, 123, '123', '123', 'adsl', NULL, 123, ''),
...
CREATE TABLE `bnm_subscribers` (
  `id` int(11) NOT NULL,
  `noe_moshtarak` varchar(20) COLLATE utf8_persian_ci DEFAULT NULL,
...
(8, 'مرکز1', '10', '33', '123', 123, 123, 'fsd', 'sdfsdf', 'sff', '1', '1', NULL);
...
(1, '3', '32', '8', '1', '123', '123', '123', '123', '123', '2', '1', '123', '123', '123', '123');
...
--
-- Dumping data for table `bnm_wireless_ap`
--

INSERT INTO `bnm_wireless_ap` (`id`, `tarikhe_payan`, `tarikhe_sabt`, `shomare_link_sabt_samane`, `popsite`, `shenase_dakal`, `address`, `ostan`, `shahr`, `tol_joghrafiai`, `arz_joghrafiai`, `ertefae_sakhteman`, `ertefae_dakal`, `bahre_anten`, `shomare_seriale_dastgah`, `teke_bande_ferekansi`, `hadeaxar_tavane_khoroji_ferestande`, `marke_dastgah`, `modele_dastgah`, `ip_address`, `port_winbox`, `username`, `password`) VALUES
(1, '0000-00-00', '2019-12-29', 0, NULL, 'شسی', 'شسی', 'ا', 'تن', 'نت', 'ا', 0, NULL, 0, 0, 5470, 0, 'تا', 'نتا', 'ت', 0, 'ا', 'نت');
